            ...
            child: Container(
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    GlassmorphismTheme.glassWhite.withValues(alpha: 0.1),
                    GlassmorphismTheme.glassWhite.withValues(alpha: 0.05),
                  ],
                ),
                border: Border(
                  top: BorderSide(
          ...
          children: [
            Icon(
              ...
              color: isSelected
                  ...
                  : GlassmorphismTheme.glassWhite.withValues(alpha: 0.6),
              size: 24,
            ),
